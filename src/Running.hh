...
class Capsule_Running : public UMLRTCapsule
{
public:
    Capsule_Running( const UMLRTCapsuleClass * cd, UMLRTSlot * st, const UMLRTCommsPort * * border, const UMLRTCommsPort * * internal, bool isStat );
protected:
...
extern const UMLRTCapsuleClass Running;
